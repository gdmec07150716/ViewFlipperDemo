package cn.edu.gdmec.s07150716.viewflipperdemo;
...
public class MainActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rInAnim = AnimationUtils.loadAnimation(mActivity,R.anim.push_riht_in);
        rOutAnim=AnimationUtils.loadAnimation(mActivity,R.anim.push_riht_out);
